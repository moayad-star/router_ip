...
try:
    try:
        test_connect = str(requests.get("http://www.github.com/moayad-star/router_ip"))
    ...
    system("apt upgrade -y ; cd .. ; rm -rif router_ip ; git clone https://github.com/moayad-star/router_ip.git")
